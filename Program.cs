...
using LeetCodeProblems._1967._Number_of_Strings_That_Appear_as_Substrings_in_Word;
...
//var max = new MaxConsecutiveOnesClass();
//var arrMaxOnes = new int[] { 1, 0, 1, 1, 0, 1 };
//Console.WriteLine(max.FindMaxConsecutiveOnes(arrMaxOnes));


//var numbersClass = new FindNumbersClass();
//var arrFindNumbers = new int[] { 555, 901, 482, 1771 };
...
//var NumOfStringsArr = new string[] { "a", "abc", "bc", "d" };
